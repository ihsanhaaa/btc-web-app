...
@section('content')
    <div class="row">
        <div class="col">
            ...
            <div class="card">
                <div class="card-body">
                    <a href="{{ route('pemasukan-keratom.create') }}" class="btn btn-primary m-b-md">Tambah Data Penjualan</a>
                    <a href="{{ url('/income_keratom/export') }}" class="btn btn-primary m-b-md">Download Data</a>
                    <h5 class="card-title">Data Pemasukan Keratom</h5>
