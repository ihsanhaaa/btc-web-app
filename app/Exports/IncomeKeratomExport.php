...
class IncomeKeratomExport implements FromCollection, WithHeadings
{
    /**
    ...
    */
    ...
    {
        $incomeFish = IncomeKeratom::select('tanggal_jual', 'jumlah_bobot', 'harga_jual', 'total_penjualan', 'created_at')->get();
